...
guests:
   - name: "Vadym Kazulkin, Head of development at ip.labs"
...
- [The first of 26 articles about Lambda SnapStart benchmarking](https://dev.to/vkazulkin/measuring-java-11-lambda-cold-starts-with-snapstart-part-1-first-impressions-30a4)
- [AWS Lambda Snap Start for Java functions](https://docs.aws.amazon.com/lambda/latest/dg/snapstart.html)
- [AWS Lambda cold start](https://docs.aws.amazon.com/lambda/latest/operatorguide/execution-environments.html)
- [Firecracker microVM](https://firecracker-microvm.github.io/)
- [Impact of latency on revenue](https://www.gigaspaces.com/blog/amazon-found-every-100ms-of-latency-cost-them-1-in-sales)
